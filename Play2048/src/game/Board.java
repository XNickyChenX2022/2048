...
public class Board {
    ...
    public void addRandomTile() {
        int a = StdRandom.uniform(openSpaces.size());
        BoardSpot t = openSpaces.get(a);
        double v = StdRandom.uniform(); 
        if(v < .1) {gameBoard[t.getRow()][t.getCol()] = 4;}
        else{gameBoard[t.getRow()][t.getCol()]= 2;}
